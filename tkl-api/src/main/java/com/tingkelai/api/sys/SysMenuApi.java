...
public interface SysMenuApi<T> {
    ...
    ResponseMessage<T> sysMenuDelete(HttpServletRequest request, T body);
    ...
    ResponseMessage<T> sysMenuGet(HttpServletRequest request, T body);
    ...
    @RequestMapping(value = "/sys/menu/list",
            method = RequestMethod.GET)
    ResponseMessage<List<T>> sysMenuListGet(HttpServletRequest request, T body);
    ...
    ResponseMessage<T> sysMenuPut(HttpServletRequest request, T body);
}
