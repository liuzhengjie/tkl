 ...
 * @version 1.0
 */
@Api(value = "customer", description = "客户常用设置相关api", tags = "customer/setting")
@RequestMapping(value = "/v1")
public interface CustomerSettingApi<T> {

    @ApiOperation(value = "获取用户设置的常用模块列表", nickname = "customerSettingListGet", notes = "", tags={ "customer/setting", })
    @RequestMapping(value = "/customer/setting/list",
            method = RequestMethod.GET)
    ResponseMessage customerSettingListGet(T requestBody);


    @ApiOperation(value = "修改用户常用模块", nickname = "customerSettingPut", notes = "", tags={ "customer/setting", })
