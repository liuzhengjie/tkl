...
public class DictItemController extends BaseCRUDController<DictItem, Long> implements DictItemApi<DictItemVO> {
    ...
    @Override
    public ResponseMessage dictItemListGet(DictItemVO dictItemVO, BasePage basePage) {
        return list(dictItemVO, basePage);
    }

    @Override
    public ResponseMessage dictItemGet(DictItemVO dictItemVO) {
        return getEntity(dictItemVO);
    }

    @Override
    public ResponseMessage dictItemPost(@Valid DictItemVO dictItemVO) {
        return saveEntity(dictItemVO);
    }

    @Override
    public ResponseMessage dictItemPut(@Valid DictItemVO dictItemVO) {
        return updateEntity(dictItemVO);
    }

    @Override
    public ResponseMessage dictItemDelete(DictItemVO dictItemVO) {
